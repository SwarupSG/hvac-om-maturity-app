...
elements.append(Paragraph("<b>1. Preventive Maintenance</b>", normal_style))
elements.append(Paragraph("Focuses on avoiding faults and is measured by the completion rate of preventive tasks, supported by verifiable proof of work.", normal_style))
elements.append(Paragraph("<b>2. Fault Resolution Management</b>", normal_style))
elements.append(Paragraph("Focuses on resolving faults and is measured by the time taken from fault detection to resolution. The process includes:", normal_style))
